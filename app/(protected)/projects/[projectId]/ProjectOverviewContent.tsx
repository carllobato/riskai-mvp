          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={points} margin={CHART_MARGIN}>
              ...
              <Tooltip
                ...
                formatter={(value: number | string) => [`P${value}`, "Band"]}
...
export function ProjectOverviewContent({ initialData }: ProjectOverviewContentProps) {
  ...
  const runDataHref = projectId ? `/projects/${projectId}/run-data` : "/";
  const settingsHref = projectId ? `/projects/${projectId}/settings` : "/";
  const simulationHref = projectId ? `/projects/${projectId}/simulation` : "/";
